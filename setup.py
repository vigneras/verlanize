...
setup(
    ...
    description='Translate french text to verlan',  # Required
    ...
    # project.
    author='Pierre Vigneras',  # Optional

    # This should be a valid email address corresponding to the author listed
    # above.
    author_email='pierre.vigneras@gmail.com',  # Optional
